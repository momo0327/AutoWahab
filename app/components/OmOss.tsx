        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start mb-16">
          ...
          <div>
            <h2 className="text-3xl md:text-5xl font-title font-bold text-dark-blue">
              Vi är en ledande leverantör av lastbilstjänster med exakt leverans av kvalitet
            </h2>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col justify-center space-y-6">
            <p className="text-gray-600 leading-relaxed mb-4">
              Med över 20 års erfarenhet i branschen arbetar vi med köp och försäljning av lastbilar för företag i Sverige och internationellt.
            </p>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-gray-700">Proaktiv utveckling av lösningar</span>
              </div>
            </div>
