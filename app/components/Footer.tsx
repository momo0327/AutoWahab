        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="https://www.blocket.se" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-light-blue transition-colors">
                  Blocketbutik
                </a>
              </li>
              <li>
                <Link href="/kontakt" className="text-gray-300 hover:text-light-blue transition-colors">
                  Kontakt
                </Link>
              </li>
            </ul>
